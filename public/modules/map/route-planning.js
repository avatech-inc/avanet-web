        ...
        scope.getScale = function() {
            ...
            function drawCanvas(metric) {
                ...
                // imperial (miles)
                    ...
                    else if (scaleMiles <= .5) units = .1;
                    else if (scaleMiles <= 1) units = .2;
                    else if (scaleMiles < 3) units = .5;
                    else if (scaleMiles <= 7) units = 1;
                    else if (scaleMiles <= 10) units = 2;
                    else if (scaleMiles <= 20) units = 5;
                    else if (scaleMiles <= 50) units = 10;
                    else if (scaleMiles <= 100) units = 20;
                    else if (scaleMiles <= 250) units = 50;
                    else if (scaleMiles <= 400) units = 100;
                    else if (scaleMiles <= 1000) units = 200;
                    else if (scaleMiles <= 3000) units = 500;
                    else units = 1000;
                ...
                for (var i = 1; i <= totalUnits; i++) {
                    ...
                    if (metric) {
                        ...
                        var left_x = pixelsPerMile * (i - 1);
                        var right_x = pixelsPerMile * i;
                    }
                    ...
                    if (metric) {
                        ...
                        var labelNum = i * units;
                        labelText = labelNum % 1 != 0 ? labelNum.toFixed(1) : labelNum;
                        unitsText = "mi";
                    }
