...
declare namespace ProtoBuf {
    ...
    export interface MetaMessage {
        new(values?: {[key: string]: any}, var_args?: string[]): Message;
        decode(buffer?: ArrayBuffer, enc?: string): Message;
        decodeDelimited(buffer?: ArrayBuffer, enc?: string): Message;
    ...
    export interface ReflectMessage extends ReflectNamespace {
        ...
        encode(message: Message, buffer: ArrayBuffer, noVerify?: boolean): ArrayBuffer;
        calculate(message: Message): number;
        decode(buffer: ArrayBuffer, length?: number, expectedGroupEndId?: number): Message;
    }
    ...
    export interface ReflectField extends ReflectT {
        ...
        encode(value: any, buffer: ArrayBuffer): ArrayBuffer;
        encodeValue(value: any, buffer: ArrayBuffer): ArrayBuffer;
        calculate(value: any): number;
        calculateValue(value: any): number;
        decode(wireType: number, buffer: ArrayBuffer, skipRepeated?: boolean): any;
    }
